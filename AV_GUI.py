...
def execute_engine(file_path, output_text):
    if file_path:
        ...
        process = subprocess.Popen(
            [
                "C:/Users/mjank/Documents/MalDev/Antivirus/engine/x64/Debug/engine.exe",
                file_path,
            ],
...
def execute_engine_rtm(file_path, output_text):
    if file_path:
        ...
        process_rtm = subprocess.Popen(
            [
                "C:/Users/mjank/Documents/MalDev/Antivirus/engine_rtm/x64/Debug/engine_rtm.exe",
                file_path,
            ],
            stdout=subprocess.PIPE,
            universal_newlines=True,
...
def toggle_win():
    ...
    Dir_button = Button(
        ...
        command=show_directory_upload_page,
        width=42,
        height=3,
        fg="#262626",
        bg="#0f9d9a",
    ...
    rlmonitor_button = Button(
        root,
        text="Real-Time Monitoring",
        command=show_rtm_page,
        width=42,
        height=3,
        fg="#262626",
        bg="#0f9d9a",
...
my_label_rtm = Label(
    rtm_notif_on_root,
    text="Real-Time Monitoring logs",
...
file_label = Label(
    file_upload_page, text="", font=("Helvetica", 12, "bold"), bg="#262626", fg="white"
)
...
my_button = Button(
    file_upload_page,
    text="Upload",
    command=lambda: execute_engine(file_path, output_text_file),
    width=28,
    height=2,
)
...
directory_entry = Entry(
    rtm_page, width=100, bg="#787a79", border=0, font=("Helvetica", 10)
)
directory_entry.pack()

directory_listbox = Listbox(
    rtm_page, border=0, width=70, height=10, bg="#787a79", font=("Helvetica", 15)
)
...
add_button = Button(
    button_frame, text="Add", command=add_item, border=0, width=20, height=3
)
add_button.pack(side=LEFT)

delete_button = Button(
    button_frame, text="Delete", command=delete_item, border=0, width=20, height=3
)
